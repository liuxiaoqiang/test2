Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.LeadExaminationChangeGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'leadExaminationChangeGrid', 
	initComponent:function(){
        ...
        var ds=new Ext.data.Store({
            scopte:this,
            url:'main/drivingLicenceOperation.html?action=getDrivingLicenceChangeOperation',
            reader:reader,
            sortInfo:{
                field:'id',
                direction:'DESC'
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceOperation.html?action=examinationLicenceChangePass",
                                    method:"post",
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceOperation.html?action=examinationLicenceChangeUnPass",
                                    method:"post",
                                    success:function(resp){
            							var result=Ext.util.JSON.decode(resp.responseText);
        								if(result.success==true){
        ...
        this.on("rowdblclick",function(grid,index,event){
            ...
            Ext.Ajax.request({
                url:"main/drivingLicenceOperation.html?action=findDrivingLicenceChangeOperationInfo",
                method:"post",
                success:function(resp){
            		var result = Ext.util.JSON.decode(resp.responseText);
					...
					if(result.data[0].drivingLicenceFlag == 1){
						Ext.getCmp("drivingLicenceFlag").setValue("是");
					}else{
						Ext.getCmp("drivingLicenceFlag").setValue("否");
					}
		            ...
		            Ext.getCmp("photoDir").getEl().dom.src = result.data[0].picture;
        ...
        Ynzc.manage.LeadExaminationChangeGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
...
Ext.reg('leadExaminationChangeGrid',Ynzc.manage.LeadExaminationChangeGrid);