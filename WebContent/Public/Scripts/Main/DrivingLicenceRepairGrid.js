Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.DrivingLicenceRepairGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'drivingLicenceRepairGrid',
	initComponent:function(){
        ...
        var expand= new Ext.ux.grid.RowExpander({
			tpl : new Ext.XTemplate(
				...
				'<tr><td>登记经办人</td><td>{[values.registerTransactor != null ? values.registerTransactor : ""]}</td><td>登记经办日期</td><td colspan="2">{[values.registerTransactorDate != null ? values.registerTransactorDate : ""]}</td></tr>',
        ...
        var ds=new Ext.data.Store({
            scopte:this,
            url:'main/drivingLicenceRepair.html?action=getDrivingLicenceRepair',
            reader:reader,
            sortInfo:{
                field:'id',
                direction:'DESC'
        ...
        Ext.apply(this,{
        	...
        	tbar:[{
        		...
        		iconCls:"icon-Add",
        		handler:function(){
	        		Ynzc.manage.addLicenceRepairwin=new Ynzc.manage.DrivingLicenceRepairWin();
	        		Ynzc.manage.addLicenceRepairwin.show();
	        		Ynzc.manage.winName = "drivingLicenceRepairWin";
        		}
        	},'-',{
                text:"业务上报",
                iconCls:"icon-Add",
                    ...
                    for(i=0;i<n;i++){
                     ...
                     Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceRepair.html?action=changeState",
                                    method:"post",
            		...
            		new Ynzc.manage.ReportWin(
        				{
        					...
        					params:{id:selections[0].data.drivingLicenceId,peopleInfoId:selections[0].data.peopleInfoId,drivingLicenceTypeId:selections[0].data.drivingLicenceTypeId,operationNameType:selections[0].data.operationNameType,operationId:selections[0].data.id,wordType:'drivingLicence',reloadType:'drivingLicenceRepairMgr',functionType:'putOut'}
        				}
        			).show();
            	}.createDelegate(this)
        	},'-',{
                    ...
                    for(i=0;i<n;i++){
                     ...
                     Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceRepair.html?action=delDrivingLicenceRepair",
                                    method:"post",
                                    success:function(resp){
            							var result=Ext.util.JSON.decode(resp.responseText);
        								if(result.success==true){
        ...
        Ynzc.manage.DrivingLicenceRepairGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
        ...
        this.on("rowdblclick",function(grid,index,event){
        	...
        	Ynzc.manage.updateLicenceRepairwin=new Ynzc.manage.DrivingLicenceRepairUpdateWin();
        	Ynzc.manage.updateLicenceRepairwin.show();
            Ynzc.manage.drivingLicenceRepairId=record.data.id;
...
Ext.reg('drivingLicenceRepairGrid',Ynzc.manage.DrivingLicenceRepairGrid);