Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.LeadExaminationShiftToGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'leadExaminationShiftToGrid',
	initComponent:function(){
        ...
        var ds=new Ext.data.Store({
            scopte:this,
            url:'main/drivingLicenceOperation.html?action=getDrivingLicenceShiftToOperation',
            reader:reader,
            sortInfo:{
                field:'id',
                direction:'DESC'
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceOperation.html?action=examinationLicencePass",
                                    method:"post",
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceOperation.html?action=examinationLicenceUnPass",
                                    method:"post",
                                    success:function(resp){
            							var result=Ext.util.JSON.decode(resp.responseText);
        								if(result.success==true){
        ...
        Ynzc.manage.LeadExaminationShiftToGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
...
Ext.reg('leadExaminationShiftToGrid',Ynzc.manage.LeadExaminationShiftToGrid);