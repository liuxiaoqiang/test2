Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.TractorUpdateWin = Ext.extend(Ext.Window, {
    id: 'tractorupdatewin',
...
//                      }
                      	...
                      	items:[{
                              ...
                              items:[{
                              	...
                              	items:[{                                
                              		...
                              		listeners: {
                                          'select': function(combo, record, index) {
                                              if (record.data.value == "合格" || record.data.value == "检验合格") {   
              ...
              buttons: [{
                  ...
                  handler: function() {
                      ...
                      if (Ext.getCmp("istemplived").getValue()=="否"&&Ext.getCmp("tempaddress").getValue() == "") {
                      ...
                      if (Ext.getCmp("istemplived").getValue()=="否"&&Ext.getCmp("timplivefileno").getValue() == "") {
...
//                      }
                      //注册信息
                      var regstr = "{id:"+Ynzc.manage.registerinfoid+",registerdate:'" + Ext.util.Format.date(Ext.getCmp("registerdate").getValue(), 'Y-m-d') + "',turnindate:'"+DateFormat.format(new Date(),'yyyy-MM-dd')+"',issuedate:'" + Ext.util.Format.date(Ext.getCmp("issuedate").getValue(), 'Y-m-d') + "',beforeregion:''}";
...
//                      }
        ...
        Ynzc.manage.TractorUpdateWin.superclass.initComponent.apply(this, arguments);
    }
});