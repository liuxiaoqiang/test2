Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.ValidateListWin=Ext.extend(Ext.Window,{
	id:"validateListWin",
	initComponent:function(){
                    					...
                    					buttons:[{
                    						...
                    						handler:function(){
                    							if(Ext.getCmp("outLength").getValue()==""||Ext.getCmp("outWidth").getValue()==""||Ext.getCmp("outHeight").getValue()==""){
                    								...
                    								Ext.getCmp("shapeSize").setValue(res);
				...
				if(Ext.getCmp("steelSpring").getValue()==""){Ext.ux.Toast.msg("提示","请填写钢板弹簧片数!");return}
					Ext.Ajax.request({
						...
						params:{
							...
							engineBrandId:Ext.getCmp("engineBrandId").getMyValue(),
		...
		Ynzc.manage.ValidateListWin.superclass.initComponent.apply(this,arguments);
	}
});