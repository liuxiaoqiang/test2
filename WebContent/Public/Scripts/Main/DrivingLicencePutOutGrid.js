Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.DrivingLicencePutOutGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'drivingLicencePutOutGrid',
	initComponent:function(){
        ...
        var ds=new Ext.data.Store({
            scopte:this,
            url:'main/drivingLicence.html?action=getDrivingLicencePutOut',
            reader:reader,
            sortInfo:{
                field:'id',
                direction:'DESC'
...
//            },'-',
            {
        		...
        		handler:function(){
                    ...
                    Ext.Ajax.request({
                        url:"main/drivingLicence.html?action=checkDrivingLicenceOperation",
                        method:"post",
                        success:function(resp){
							...
							if(result.success==true){
			            		...
			            		new Ynzc.manage.ReportWin(
		            				{
		            					title:'打印',
		            					sourceURL:'main/drivingLicenceReport.html?action=getDrivingLicenceReport',
		            					params:{id:selections[0].data.id,peopleInfoId:selections[0].data.peopleInfoId,drivingLicenceId:selections[0].data.drivingLicenceId,drivingLicenceTypeId:selections[0].data.drivingLicenceTypeId,functionType:'putOut',operationNameType:"0",wordType:'drivingLicence',reloadType:'driverlicencePutOutMgr'}
		            				}
		            			).show();
							}
                        },
        ...
        Ynzc.manage.DrivingLicencePutOutGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
...
Ext.reg('drivingLicencePutOutGrid',Ynzc.manage.DrivingLicencePutOutGrid);