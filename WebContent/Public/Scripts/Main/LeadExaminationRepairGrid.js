Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.LeadExaminationRepairGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'leadExaminationRepairGrid',
	initComponent:function(){
        ...
        var ds=new Ext.data.Store({
            scopte:this,
            url:'main/drivingLicenceOperation.html?action=getDrivingLicenceRepairOperation',
            reader:reader,
            sortInfo:{
                field:'id',
                direction:'DESC'
        ...
        Ynzc.manage.LeadExaminationRepairGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
...
Ext.reg('leadExaminationRepairGrid',Ynzc.manage.LeadExaminationRepairGrid);