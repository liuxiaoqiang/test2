Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.LeadExaminationLicenceGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'leadExaminationLicenceGrid',
	initComponent:function(){
            ...
            tbar:[{
                ...
                handler:function(){
                	...
                	if(selections[0].data.state>=2){
                		Ext.MessageBox.alert("提示",selections[0].data.state+"已经审核过了!");
                		return;
                	}else{
        ...
        Ynzc.manage.LeadExaminationLicenceGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
...
Ext.reg('leadExaminationLicenceGrid',Ynzc.manage.LeadExaminationLicenceGrid);