Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.PlateDisWin=Ext.extend(Ext.grid.GridPanel,{
                id:'platediswin',
    ...
    var cm = new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),sm,{
        header:'所在区<font color=red>/</font>县',
        sortable:true,
        dataIndex:"region"
    },{ 
        header:'未用号牌',
    ...
    var ds=new Ext.data.Store({
        scopte:this,
        url:'main/plate.html?action=getAreaPlate',
        reader:reader,
        sortInfo:{
            field:'id',
            direction:'ASC'
    ...
    Ext.apply(this,{
        ...
        tbar:[{
        	...
        	handler:function(){
        		...
        		if(n==0){
        			Ext.ux.Toast.msg("提示","请选中要分配的市级单位!");
        			return;
        		}
        		if(n>1){
...
Ext.reg('platediswin',Ynzc.manage.PlateDisWin);