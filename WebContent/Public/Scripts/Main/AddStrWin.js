Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.AddStrWin=Ext.extend(Ext.Window,{
	id:"addStrWin",
	initComponent:function(){
	        ...
	        items:[{
	        	...
	        	items:[{
	        		...
	        		items:[{
		                ...
		                selectOnFoucs : true,
		                triggerAction : 'all',
		                store:Ynzc.manage.ApplicationTypeNewStore,
		                emptyText:"请选择申请类型",
		                anchor:'98%'
	        		}]
	        	},{
			...
			buttons:[{
				...
				handler:function(){
					...
					if(checkPost(Ext.getCmp("postalcode").getValue())){
						Ext.MessageBox.alert('系统提示','邮编填写有误!');
						initFocus("postalcode");
						return;
					}
					if(Ext.getCmp("drivingLicenceType").getValue()===""){
						Ext.MessageBox.alert('系统提示','请选择申请驾驶类型!');
						return;
					}
					if(Ext.getCmp("degree").getValue()===""){
						Ext.MessageBox.alert('系统提示','请填写文化程度!');
						return;
					}
					if(Ext.getCmp("photoDir").getValue() == null){
					...
					if(checkLen(Ext.getCmp("checkDoctor").getValue()) || Ext.getCmp("checkDoctor").getValue() != undefined){
	                ...
	                mask.show();
					Ext.Ajax.request({
						url:"main/peopleInfo.html?action=addPeopleBodyInfo",
		...
		Ynzc.manage.AddStrWin.superclass.initComponent.apply(this,arguments);
	}
});
