Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.DrivinglicenceGotoWin = Ext.extend(Ext.Window, {
    id: 'drivinglicenceGotoWin',
    initComponent: function() {
		Ext.apply(this,{
			...
			buttons:[{
				...
				handler:function(){
	                ...
	                mask.show();
					Ext.Ajax.request({
						url:"main/drivingLicenceGoto.html?action=addDrivingLicenceGoto",
						success:function(resp){
							...
							if(result.success==true){
								if(result.success==true){
									...
									Ext.getCmp("drivinglicenceGotoWin").close();
								}else{
									Ext.MessageBox.alert("提示",result.reason);
								}
							}else{
						...
						params:{
							...
							rightEarPwoerId:Ext.getCmp("rightEarPwoerId").getValue(),
							leftEarPwoerId:Ext.getCmp("leftEarPwoerId").getValue(),
		...
		Ynzc.manage.DrivinglicenceGotoWin.superclass.initComponent.apply(this,arguments);
	}
});