Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.PlateLibGridBatchWin=Ext.extend(Ext.Window,{
	id:"platelibgridbatchwin",
...
//				readOnly:true,
			...
			Ext.Ajax.request({
			    ...
			    mask.hide();
   			 		...
   			 		if(result.success == true){
   			 			...
   			 			Ext.getCmp("platelibgridbatchwin").close();
   			 		}
				},
				failure:function(){
	...
	Ynzc.manage.PlateLibGridBatchWin.superclass.initComponent.apply(this,arguments);
	}
});