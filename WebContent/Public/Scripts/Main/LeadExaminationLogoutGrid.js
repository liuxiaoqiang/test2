Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.LeadExaminationLogoutGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'leadExaminationLogoutGrid',
	initComponent:function(){
        ...
        var ds=new Ext.data.Store({
            scopte:this,
            url:'main/drivingLicenceOperation.html?action=getDrivingLicenceLogoutOperation',
            reader:reader,
            sortInfo:{
                field:'id',
                direction:'DESC'
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceOperation.html?action=examinationLicenceLogoutPass",
                                    method:"post",
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceOperation.html?action=examinationLicenceLogoutUnPass",
                                    method:"post",
                                    success:function(resp){
            							var result=Ext.util.JSON.decode(resp.responseText);
        								if(result.success==true){
        ...
        this.on("rowdblclick",function(grid,index,event){
            ...
            Ext.Ajax.request({
                url:"main/drivingLicenceOperation.html?action=findDrivingLicenceLogoutOperationInfo",
                method:"post",
                success:function(resp){
            		var result = Ext.util.JSON.decode(resp.responseText);
        ...
        Ynzc.manage.LeadExaminationLogoutGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
...
Ext.reg('leadExaminationLogoutGrid',Ynzc.manage.LeadExaminationLogoutGrid);