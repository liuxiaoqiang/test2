Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.TheoryExamUpdateWin=Ext.extend(Ext.Window,{
	id:"theoryExamUpdateWin",
	initComponent:function(){
			...
			buttons:[{
				...
				handler:function(){
					...
					if(Ext.getCmp("theoryDate").getValue()==""){
						Ext.MessageBox.alert("提示","请填写初考时间!");
						return;
					}
					...
					if(!checkNum(Ext.getCmp("theoryResult").getValue())){
						if(Ext.getCmp("theoryResult").getValue() < 80){
							if(!checkNum(Ext.getCmp("makeupResult").getValue())){
								if(Ext.getCmp("makeupResult").getValue() < 80){
					...
					Ext.Ajax.request({
						url:"main/theoryExam.html?action=updateTheoryExam",
						...
						mask.hide();
							...
							if(result.success==true){
								...
								Ext.getCmp("theoryExamUpdateWin").close();
							}else{
		...
		Ynzc.manage.TheoryExamUpdateWin.superclass.initComponent.apply(this,arguments);
	}
});