Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.ReaperPlateSubmitChangeWin=Ext.extend(Ext.Window,{
	id:"reaperplatesubmitchangewin",
	initComponent:function(){    
		...
		var npDs=new Ext.data.Store({
            ...
            url:'main/reaperPlate.html?action=getNewChangePlateList',
            reader:npReader,
            sortInfo:{
                field:'id',
                direction:'ASC'
		...
		Ynzc.manage.ReaperPlateSubmitChangeWin.superclass.initComponent.apply(this,arguments);
		npDs.load({
			params:{
				start:0,
				limit:6
