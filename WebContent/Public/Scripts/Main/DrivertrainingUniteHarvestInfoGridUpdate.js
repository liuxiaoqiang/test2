Ext.ns("Ynzc");
Ext.ns("Ynzc.manage"); 
Ynzc.manage.DrivertrainingUniteHarvestInfoGridUpdate=Ext.extend(Ext.Window,{
                id:'drivertrainingUniteHarvestInfoGridUpdate',
                initComponent:function(){
                    Ext.apply(this,{
                    	id:'tractorregisterwin',
			            title:"教练车注册登记信息修改(联合收割机)",
			            iconCls:'icon-Add',
			            resizable:false,
			            modal:true,
			            height:230,
			            	...
			            	handler:function(){
			            		...
			            		Ext.Ajax.request({
			            			...
			            			success:function(){
			            				...
			            				Ext.getCmp("drivertrainingUniteHarvestInfoGridUpdate").close();
			            			},
			            			params:{
                 ...
                 Ynzc.manage.DrivertrainingUniteHarvestInfoGridUpdate.superclass.initComponent.apply(this,arguments);
                }
});