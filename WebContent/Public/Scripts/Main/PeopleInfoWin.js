Ext.ns("Ynzc"); 
Ext.ns("Ynzc.manage");
Ynzc.manage.PeopleInfoWin=Ext.extend(Ext.Window,{
	id:"peopleInfoWin",
	initComponent:function(){
		Ext.apply(this,{
			...
			buttons:[{
				...
				handler:function(){
					...
					Ext.Ajax.request({
						url:"main/peopleInfo.html?action=addPeopleInfo",
						success:function(resp){
							...
							if(result.success==true){
								if(result.success==true){
									...
									Ext.getCmp("peopleInfoWin").close();
								}else{
									Ext.MessageBox.alert("提示",result.reason);
								}
							}else{
						...
						params:{
							...
							nativePlace:trim(Ext.getCmp("nativePlace").getValue()),
		...
		Ynzc.manage.PeopleInfoWin.superclass.initComponent.apply(this,arguments);
	}
});
