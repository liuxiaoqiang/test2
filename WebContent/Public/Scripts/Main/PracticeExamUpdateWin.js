Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.PracticeExamUpdateWin=Ext.extend(Ext.Window,{
	id:"practiceExamUpdateWin",
	initComponent:function(){
			...
			buttons:[{
				...
				handler:function(){
					...
					if(checkNum(Ext.getCmp("fieldResult").getValue())){
						Ext.MessageBox.alert("提示","地考初考绩填写有误!");
					...
					if(!checkNum(Ext.getCmp("fieldResult").getValue())){
						if(Ext.getCmp("fieldResult").getValue() < 70 && Ext.getCmp("makeupFieldResult").getValue() !==""){
							if(!checkNum(Ext.getCmp("makeupFieldResult").getValue())){
								if(Ext.getCmp("makeupFieldResult").getValue() < 70){
					...
					if(!checkNum(Ext.getCmp("machineResult").getValue())){
						if(Ext.getCmp("machineResult").getValue() < 70 && Ext.getCmp("makeupMachineResult").getValue() !==""){
							if(!checkNum(Ext.getCmp("makeupMachineResult").getValue())){
								if(Ext.getCmp("makeupMachineResult").getValue() < 70){
					...
					if(!checkNum(Ext.getCmp("roadResult").getValue())){
						if(Ext.getCmp("roadResult").getValue() < 70 && Ext.getCmp("makeupRoadResult").getValue() !==""){
							if(!checkNum(Ext.getCmp("makeupRoadResult").getValue())){
								if(Ext.getCmp("makeupRoadResult").getValue() < 70){
	                ...
	                mask.show();
					Ext.Ajax.request({
						url:"main/practiceExam.html?action=updatePracticeExam",
						...
						mask.hide();
							...
							if(result.success==true){
								...
								Ext.getCmp("practiceExamUpdateWin").close();
							}else{
		...
		Ynzc.manage.PracticeExamUpdateWin.superclass.initComponent.apply(this,arguments);
	}
});