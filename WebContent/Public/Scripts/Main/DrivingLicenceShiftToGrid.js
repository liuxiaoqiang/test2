Ext.ns("Ynzc");
Ext.ns("Ynzc.manage"); 
Ynzc.manage.DrivingLicenceShiftToGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'drivingLicenceShiftToGrid',
	initComponent:function(){
        ...
        var expand= new Ext.ux.grid.RowExpander({
			tpl : new Ext.XTemplate(
				...
				'<tr><td colspan="5" align="center">驾照转出信息</td></tr>',
        ...
        var ds=new Ext.data.Store({
            scopte:this,
            url:'main/drivingLicenceShiftTo.html?action=getDrivingLicenceShiftTo',
            reader:reader,
            sortInfo:{
                field:'id',
                direction:'DESC'
        ...
        Ext.apply(this,{
        	...
        	tbar:[{
        		...
        		iconCls:"icon-Add",
        		handler:function(){
		        	Ynzc.manage.addLicenceShiftwin=new Ynzc.manage.DrivingLicenceShiftToWin();
	        		Ynzc.manage.addLicenceShiftwin.show();
	        		Ynzc.manage.winName = "drivingLicenceShiftToWin";
	        		Ext.getCmp("shiftToAddress").setValue(UnitAddress);
        		}
        	},'-',{
                text:"业务上报",
                iconCls:"icon-Add",
                    ...
                    for(i=0;i<n;i++){
                     ...
                     Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceShiftTo.html?action=changeState",
                                    method:"post",
        		...
        		handler:function(){
            		...
            		new Ynzc.manage.ReportWin(
        				{
        					title:'打印',
        					sourceURL:'main/drivingLicenceReport.html?action=tractorLicenseOutNotice',
                    ...
                    for(i=0;i<n;i++){
                     ...
                     Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceShiftTo.html?action=delDrivingLicenceShiftTo",
                                    method:"post",
                                    success:function(resp){
            							var result=Ext.util.JSON.decode(resp.responseText);
        								if(result.success==true){
        ...
        Ynzc.manage.DrivingLicenceShiftToGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
        ...
        this.on("rowdblclick",function(grid,index,event){
        	...
        	Ynzc.manage.updateLicenceShiftwin=new Ynzc.manage.DrivinglicenceShiftToUpdateWin();
        	Ynzc.manage.updateLicenceShiftwin.show();
            Ynzc.manage.DrivingLicenceShiftTo=record.data.id;
			Ext.getCmp("causation").setValue(record.data.causation);
			Ext.getCmp("shiftToAddress").setValue(record.data.shiftToAddress);
...
Ext.reg('drivingLicenceShiftToGrid',Ynzc.manage.DrivingLicenceShiftToGrid);