Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.LeadExaminationGotoGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'leadExaminationGotoGrid',
	initComponent:function(){ 
        ...
        var ds=new Ext.data.Store({
            scopte:this,
            url:'main/drivingLicenceOperation.html?action=getDrivingLicenceGotoOperation',
            reader:reader,
            sortInfo:{
                field:'id',
                direction:'DESC'
        ...
        Ynzc.manage.LeadExaminationGotoGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
...
Ext.reg('leadExaminationGotoGrid',Ynzc.manage.LeadExaminationGotoGrid);