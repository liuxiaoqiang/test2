Ext.ns("Ynzc");
Ext.ns("Ynzc.manage"); 
Ynzc.manage.BrandTypeCombo=Ext.extend(Ext.form.ComboBox,{
			id:'validatecombo',
			selectValue:null,
			initComponent:function(){
				...
				Ynzc.manage.BrandTypeCombo.superclass.initComponent.apply(this,arguments);
...
Ext.reg("brandcombo",Ynzc.manage.BrandTypeCombo)