Ext.ns("Ynzc");
Ext.ns("Ynzc.manage"); 
Ynzc.manage.DrivertrainingCheckInfoGridUpdate=Ext.extend(Ext.Window,{
                id:'drivertrainingcheckinfoupdates',
                initComponent:function(){
                    Ext.apply(this,{
                    	id:'drivertrainingcheckinfoupdates',
			            title:"教练车年度检验信息修改(拖拉机)",
			            iconCls:'icon-Add',
			            resizable:false,
			            modal:true,
			            height:260,
			            ...
			            buttons:[{
			            	...
			            	handler:function(){
			            		...
			            		if(Ext.getCmp("baoxianName").getValue()==""){Ext.ux.Toast.msg("操作提示","[<font color=red>检验登记事项</font>][<font color=red>保险公司名称</font>]为空，请选择。");return}
			            		...
			            		Ext.Ajax.request({
			            			url:'main/drivertrainingCheckInfo.html?action=updateDrivertrainingCheckInfo',
			            			success:function(data){
			            					var result=Ext.util.JSON.decode(data.responseText);
			            					Ext.ux.Toast.msg("操作提示",result.reason);
			            					Ext.getCmp("save").enable();
			            					Ext.getCmp("drivertrainingcheckinfoupdates").close();
			            			...
			            			params:{
			            				...
			            				EnteyMan:loginUser,
			            				id:Ynzc.manage.drivertraincheckinfoId,//年检id
			            				drivetraininfoid:Ynzc.manage.drivertraininfoId//教练车id
			            			}
			            		});
			            	}
			            },{
                 ...
                 Ynzc.manage.DrivertrainingCheckInfoGridUpdate.superclass.initComponent.apply(this,arguments);
                }
});