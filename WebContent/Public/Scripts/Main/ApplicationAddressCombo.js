Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.ApplicationAddressCombo=Ext.extend(Ext.form.ComboBox,{
			id:'applicationAddressCombo',
			initComponent:function(){
								...
								if(node.id=="combroot"){
									...
									Ext.Ajax.request({
										...
										success:function(resp){
											...
											Ext.getCmp("applicationAddress").setValue(result.str);
										},
										failure:function(){
				...
				Ynzc.manage.ApplicationAddressCombo.superclass.initComponent.apply(this,arguments);
...
Ext.reg("applicationAddressCombo",Ynzc.manage.ApplicationAddressCombo)