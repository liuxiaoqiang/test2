Ext.ns("Ynzc");
Ext.ns("Ynzc.manage"); 
Ynzc.manage.DrivingLicenceTermWin = Ext.extend(Ext.Window, {
    id: 'drivingLicenceTermWin',
    initComponent: function() {
				...
				items:[{
					...
					items:[{
										...
										buttons:[{
											...
											handler:function(){
												if(Ext.getCmp("changeRightEarPwoer").getValue()==""){
													...
													var res=Ext.getCmp("changeRightEarPwoer").getValue()+"米";
													Ext.getCmp("changeRightEarPwoerId").setValue(res);
													Ext.getCmp("rightEarPwoerwin").close();	
													}
												}
											}]
										}).show(Ext.getCmp("changeRightEarPwoerId").getEl());
										if(Ext.getCmp("changeRightEarPwoerId").getValue()!=""){
											var strArray=Ext.getCmp("changeRightEarPwoerId").getValue().replace("米","");
											Ext.getCmp("changeRightEarPwoerId").setValue(strArray);
										}
									}
								},
								anchor:'98%'
											...
											buttons:[{
												...
												handler:function(){
													if(Ext.getCmp("changeLeftEarPwoer").getValue()==""){
														...
														var res=Ext.getCmp("changeLeftEarPwoer").getValue()+"米";
														Ext.getCmp("changeLeftEarPwoerId").setValue(res);
														Ext.getCmp("leftEarPwoerwin").close();	
														}
													}
												}]
											}).show(Ext.getCmp("changeLeftEarPwoerId").getEl());
											if(Ext.getCmp("changeLeftEarPwoerId").getValue()!=""){
												var strArray=Ext.getCmp("changeLeftEarPwoerId").getValue().replace("米","");
												Ext.getCmp("changeLeftEarPwoerId").setValue(strArray);
											}
										}
									},
									anchor:'98%'
						...
						listeners:{'collapse':function(obj){                            
								if(Ext.get('addLicence') && clickType1 ==="0" && clickTyep2 ==="0"){
									Ynzc.manage.addLicencewin.setHeight(480);							         
								}
								if(Ext.get('addLicence') && clickType1 ==="1" && clickTyep2 ==="0"){
									Ynzc.manage.addLicencewin.setHeight(480);
									clickType1 = "0";
								}
								if(Ext.get('addLicence') && clickType1 ==="1" && clickTyep2 ==="1"){
									Ynzc.manage.addLicencewin.setHeight(559);
									clickType1 ="0";
								}
							},
							'expand':function(obj){					
								Ynzc.manage.addLicencewin.setHeight(611);
								clickType1 ="1";
							}
						},
						collapsed:true,
						...
						titleCollapse:true,
						listeners:{'collapse':function(obj){                            
								if(Ext.get('addLicence') && clickTyep2 ==="0" && clickType1==="0"){
									Ynzc.manage.addLicencewin.setHeight(480);   					         
									}
								if(Ext.get('addLicence') && clickType1 ==="0"  && clickTyep2 ==="1"){
									Ynzc.manage.addLicencewin.setHeight(480);
									clickTyep2 ="0";
									}
								if(Ext.get('addLicence') && clickType1 ==="1"  && clickTyep2 ==="1"){
			...
			buttons:[{
				...
				handler:function(){
					...
					if(Ext.getCmp("changeRightEarPwoerId").getValue() === ""){
						...
						initFocus("changeRightEarPwoerId");
						return;
					}
					if(Ext.getCmp("changeLeftEarPwoerId").getValue() === ""){
						Ext.MessageBox.alert("提示","请填写左耳听力!");
						initFocus("changeLeftEarPwoerId");
						return;
					}
	                ...
	                mask.show();
					Ext.Ajax.request({
						url:"main/drivingLicenceTerm.html?action=addDrivingLicenceTerm",
						success:function(resp){
							...
							if(result.success==true){
								if(result.success==true){
									...
									Ext.getCmp("drivingLicenceTermWin").close();
								}else{
									Ext.MessageBox.alert("提示",result.reason);
								}
							}else{
						...
						params:{
							...
							changeRightEarPwoerId:Ext.getCmp("changeRightEarPwoerId").getValue(),
							changeLeftEarPwoerId:Ext.getCmp("changeLeftEarPwoerId").getValue(),
		...
		Ynzc.manage.DrivingLicenceTermWin.superclass.initComponent.apply(this,arguments);
	}
});
var clickType1 ="0";
var clickTyep2 ="0";