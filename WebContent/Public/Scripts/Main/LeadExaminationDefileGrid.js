Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.LeadExaminationDefileGrid=Ext.extend(Ext.grid.GridPanel,{
	id:'leadExaminationDefileGrid',
	initComponent:function(){ 
        ...
        var ds=new Ext.data.Store({
            scopte:this,
            url:'main/drivingLicenceOperation.html?action=getDrivingLicenceDefileOperation',
            reader:reader,
            sortInfo:{
                field:'id',
                direction:'DESC'
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceOperation.html?action=examinationLicenceDefilePass",
                                    method:"post",
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn:function(btn){
                            if(btn=="yes"){
                                Ext.Ajax.request({
                                    url:"main/drivingLicenceOperation.html?action=examinationLicenceDefileUnPass",
                                    method:"post",
                                    success:function(resp){
            							var result=Ext.util.JSON.decode(resp.responseText);
        								if(result.success==true){
        ...
        Ynzc.manage.LeadExaminationDefileGrid.superclass.initComponent.apply(this,arguments);
        ds.load({
        	params:{
	        	start:0,
	        	limit:20
...
Ext.reg('leadExaminationDefileGrid',Ynzc.manage.LeadExaminationDefileGrid);