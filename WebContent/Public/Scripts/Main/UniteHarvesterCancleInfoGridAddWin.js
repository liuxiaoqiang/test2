Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.UniteHarvesterCancleInfoGridAddWin=Ext.extend(Ext.Window,{
                id:'uniteHarvesterCancleInfoGridAddWin',
                initComponent:function(){
                    Ext.apply(this,{
			            ...
			            buttons:[{
			            	...
			            	handler:function(){
			            		...
			            		Ext.Ajax.request({
			            			url:'main/uniteharvesterCancleInfo.html?action=addUniteharvesterCancle',
			            			success:function(res){
			            				...
			            				if(result.success==true){
				            				...
				            				Ext.getCmp("uniteHarvesterCancleInfoGridAddWin").close();
			            				}else{
			            					Ext.ux.Toast.msg("操作提示",result.reason);
			            				}
			            			},
                 ...
                 Ynzc.manage.UniteHarvesterCancleInfoGridAddWin.superclass.initComponent.apply(this,arguments);
                }
});