Ext.ns("Ynzc");
Ext.ns("Ynzc.manage");
Ynzc.manage.TheoryExamMakeupWin=Ext.extend(Ext.Window,{
	id:"theoryExamMakeupWin",
	initComponent:function(){
		Ext.apply(this,{
			...
			items:[{
				...
				items:[{
					...
					items:[{
						...
						baseCls:"x-plain",
						items:[{
							id:"auditingTheoryResultMakeupFlag",
							fieldLabel:"结论",
							xtype:"combo",
							displayField : 'display',
							valueField : 'value',
			...
			buttons:[{
				...
				handler:function(){
					...
					if(Ext.getCmp("auditingTheoryIdeaMakeupFlag").getValue()===""){
						Ext.MessageBox.alert("提示","请填选择核发学习驾驶证意见!");
						return;
					}
					if(Ext.getCmp("unitTheoryAuditingIdeaMakeupFlag").getValue()===""){
						Ext.MessageBox.alert("提示","请填选择地、（州、市）农机监理部门意见!");
						return;
					}
					if(Ext.getCmp("unitTheoryAuditingIdeaMakeupDate").getValue()==""){
						Ext.MessageBox.alert("提示","请填写地、（州、市）农机监理部门意见填写时间!");
						return;
					}
					if(Ext.getCmp("auditingTheoryResultMakeupFlag").getValue()===""){
					...
					Ext.Ajax.request({
						url:"main/theoryExam.html?action=addTheoryExamMakeup",
						...
						mask.hide();
							...
							if(result.success==true){
								...
								Ext.getCmp("theoryExamMakeupWin").close();
							}else{
		...
		Ynzc.manage.TheoryExamMakeupWin.superclass.initComponent.apply(this,arguments);
	}
});