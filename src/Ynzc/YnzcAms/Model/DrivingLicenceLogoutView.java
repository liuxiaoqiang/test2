...
@Entity
@Table(name = "ynzc_drivinglicencelogout_view")
public class DrivingLicenceLogoutView {
	private int id;//编号
	private int bodyInfoId;//健康信息Id
	...
	private int auditingLogoutFlag;//注销审核
	private Date auditingLogoutDate;//注销审核日期
	...
	public int getAuditingLogoutFlag() {
		return auditingLogoutFlag;
	}
	public void setAuditingLogoutFlag(int auditingLogoutFlag) {
		this.auditingLogoutFlag = auditingLogoutFlag;
	}
	public Date getAuditingLogoutDate() {
		return auditingLogoutDate;
	}
	public void setAuditingLogoutDate(Date auditingLogoutDate) {
		this.auditingLogoutDate = auditingLogoutDate;
	}
