...
@Entity
@Table(name = "ynzc_drivinglicencechange_view")
public class DrivingLicenceChangeView {
	private int id;//编号
	...
	private String auditingChangeDate;//信息变更审核日期
	...
	public String getAuditingChangeDate() {
		return auditingChangeDate;
	}
	public void setAuditingChangeDate(String auditingChangeDate) {
