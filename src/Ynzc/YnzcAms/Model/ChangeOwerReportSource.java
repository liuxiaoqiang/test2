...
public class ChangeOwerReportSource {
	//tractor
	...
	private int orgincertificateid;
	...
	public int getOrgincertificateid() {
		return orgincertificateid;
	}
	public void setOrgincertificateid(int orgincertificateid) {
