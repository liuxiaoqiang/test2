...
@Entity
@Table(name = "ynzc_tractorreplacementinfo_view")
public class TractorReplacementInfoView {
	public int id;
	...
	public void setSelevanceVoucher(String selevanceVoucher) {
		this.selevanceVoucher = selevanceVoucher;
	}
