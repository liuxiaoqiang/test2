...
@Entity
@Table(name = "ynzc_drivinglicencerepair_view")
public class DrivingLicenceRepairView {
	private int id;//编号
	private int operationNameType;//业务名称
	private int drivingLicenceId;//驾照Id
	private int bodyInfoId;//身体状况信息Id
	private int peopleInfoId;//人员Id
	private String causation;//原因
	private int proveType;//证明类型
	private String proveId;//证明身份Id
	private int auditingRepairFlag;//补证审核
	private Date auditingRepairDate;//补证审核日期
	private String registerTransactor;//登记经办人
	private String registerTransactorDate;//登记经办日期
	...
	private Date pigeonholeTransactorDate;//归档经日期
	...
	public int getAuditingRepairFlag() {
		return auditingRepairFlag;
	}
	public void setAuditingRepairFlag(int auditingRepairFlag) {
		this.auditingRepairFlag = auditingRepairFlag;
	}
	public Date getAuditingRepairDate() {
		return auditingRepairDate;
	}
	public void setAuditingRepairDate(Date auditingRepairDate) {
		this.auditingRepairDate = auditingRepairDate;
	}
