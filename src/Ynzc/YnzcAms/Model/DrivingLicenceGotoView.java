...
@Entity
@Table(name = "ynzc_drivinglicencegoto_view")
public class DrivingLicenceGotoView {
	private int id;//编号
	...
	private int auditingGotoFlag;//转入审核
	private Date auditingGotoDate;//转入审核日期
	...
	public int getAuditingGotoFlag() {
		return auditingGotoFlag;
	}

	public void setAuditingGotoFlag(int auditingGotoFlag) {
		this.auditingGotoFlag = auditingGotoFlag;
	}

	public Date getAuditingGotoDate() {
		return auditingGotoDate;
	}

	public void setAuditingGotoDate(Date auditingGotoDate) {
		this.auditingGotoDate = auditingGotoDate;
	}
